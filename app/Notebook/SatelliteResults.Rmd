...
library(grid)
library(foreign)
read_chunk("../visualise_results/result_table.R")
read_chunk("../visualise_results/mds.R")
read_chunk("../visualisation.R")
read_chunk("../visualise_results/heatmaps.R")
read_chunk("../visualise_results/detailed_likelihood.R")
read_chunk("../visualise_results/detailed_posterior.R")
read_chunk("../verification/read_data.R")
read_chunk("../verification/compare_distributions.R")
```
...
<<results>>
  results.prior.1 <- ResultTable(paste0("../../data_out/train_seed/",
                                        params$file1, "_", params$file2, "/FrequencyMaps/",
                                        params$file1, "_", params$file2, "_1-attributes_covariate.csv"))
  results.prior.2 <- ResultTable(paste0("../../data_out/train_seed/", 
                                        params$file1, "_", params$file2, "/FrequencyMaps/",
                                        params$file1, "_", params$file2, "_2-attributes_covariate.csv"))
  results.prior.3 <- ResultTable(paste0("../../data_out/train_seed/", 
                                        params$file1, "_", params$file2, "/FrequencyMaps/",
                                        params$file1, "_", params$file2, "_3-attributes_covariate.csv"))
  results.cc.1 <- ResultTable(paste0("../../data_out/train_seed/", 
                                     params$file1, "_", params$file2, "/FrequencyMaps/",
                                     params$file1, "_", params$file2, "_1-attributes_likelihood.csv"))
  results.cc.2 <- ResultTable(paste0("../../data_out/train_seed/", 
                                     params$file1, "_", params$file2, "/FrequencyMaps/",
                                     params$file1, "_", params$file2, "_2-attributes_likelihood.csv"))
  results.cc.detailed.1 <- ResultTable(paste0("../../data_out/train_seed/", 
                                              params$file1, "_", params$file2, "/FrequencyMaps/",
                                              params$file1, "_", params$file2,
                                              "_1-attributes_likelihood_detailed.csv"))
  results.cc.detailed.2 <- ResultTable(paste0("../../data_out/train_seed/", 
                                              params$file1, "_", params$file2, "/FrequencyMaps/",
                                              params$file1, "_", params$file2, 
                                              "_2-attributes_likelihood_detailed.csv"))
  results.pos.1 <- ResultTable(paste0("../../data_out/train_seed/", 
                                      params$file1, "_", params$file2, "/FrequencyMaps/",
                                      params$file1, "_", params$file2, "_1-attributes_posterior.csv")) 
  results.pos.2 <- ResultTable(paste0("../../data_out/train_seed/",  
                                      params$file1, "_", params$file2, "/FrequencyMaps/",
                                      params$file1, "_", params$file2, "_2-attributes_posterior.csv"))
  results.pos.3 <- ResultTable(paste0("../../data_out/train_seed/", 
                                      params$file1, "_", params$file2, "/FrequencyMaps/",
                                      params$file1, "_", params$file2, "_3-attributes_posterior.csv"))
```
...
```{r, include=F}
  results.new.prior.1 <- ResultTable(paste0("../../data_out/train_seed/", 
                                            "20131113", "_", params$file2, "/FrequencyMaps/", 

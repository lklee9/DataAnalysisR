...
```{r detail, echo = FALSE}
results.cov.1 <- ResultTable("../../../../../data_out/elecNormNew/analyse/1-attributes_covariate.csv")
results.joint.1 <- ResultTable("../../../../../data_out/elecNormNew/analyse/1-attributes_joint.csv")
results.pos.d.1 <- ResultTable(paste0("../../../../../data_out/elecNormNew/analyse/1-attributes_posterior_detailed.csv"))
results.pos.1 <- ResultTable(paste0("../../../../../data_out/elecNormNew/analyse/1-attributes_posterior.csv"))
results.pos.2 <- ResultTable(paste0("../../../../../data_out/elecNormNew/analyse/2-attributes_posterior.csv"))
results.like.d.1 <- ResultTable(paste0("../../../../../data_out/elecNormNew/analyse/1-attributes_likelihood_detailed.csv"))
results.like.1 <- ResultTable(paste0("../../../../../data_out/elecNormNew/analyse/1-attributes_likelihood.csv"))
results.like.2 <- ResultTable(paste0("../../../../../data_out/elecNormNew/analyse/2-attributes_likelihood.csv"))
```
...
```{r, echo = FALSE}
  VisualSingleAttributeStructure(results.pos.d.1, "posterior")
```
...
```{r}
    VisualSingleAttribute(results.cov.1)
    VisualSingleAttribute(results.joint.1)
    VisualPairAttributes(results.pos.1, results.pos.2)
    VisualPairAttributes(results.like.1, results.like.2)
```

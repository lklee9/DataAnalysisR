...
<<results>>
  ...
  results.prior.3 <- ResultTable(paste("../../data_out/martvard/", params$data_file, "_3-attributes_prior.csv", sep = ""))
  ...
  results.pos.3 <- ResultTable(paste("../../data_out/martvard/", params$data_file, "_3-attributes_posterior.csv", sep = ""))
```

...
```{r, include=F}
<<results>>
  results.prior.1 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_1-attributes_prior.csv"))
  results.prior.2 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_2-attributes_prior.csv"))
  results.prior.3 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_3-attributes_prior.csv"))
  results.cc.1 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_1-attributes_ConditionedCovariate.csv"))
  results.cc.2 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_2-attributes_ConditionedCovariate.csv"))
  results.pos.1 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_1-attributes_posterior.csv"))
  results.pos.2 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_2-attributes_posterior.csv"))
  results.pos.3 <- ResultTable(paste0("../../data_out/martvard/", params$file1, "_", params$file2, "_3-attributes_posterior.csv"))
```
